...
<div class="container">
	...
	<div class="col-md-12">
		<h1 class="m-5"><i class="fas fa-user mr-3"></i>REGISTER FORM</h1>
			...
			<table class="table">
				<tbody>
					<tr>
						...
						<td>
							<input type="text" class="form-control align-middle" name="memId" value="<%=mv.getMemId() %>" readonly="readonly">
						</td>
					</tr>
					<tr>
						<th class="align-middle">비밀번호</th>
						<td>
							<input type="password" class="form-control align-middle" name="memPw" value="<%=mv.getMemPw() %>" required="required">
						</td>
					</tr>
					<tr>
						<th class="align-middle">이메일</th>
						<td>
							<input type="email" class="form-control align-middle" name="memEmail" value="<%=mv.getMemEmail() %>" required="required">
						</td>
					</tr>
					<tr>
						<th class="align-middle">전화번호</th>
						<td>
							<input type="text" class="form-control align-middle" name="memHp" value="<%=mv.getMemHp() %>" required="required">
						</td>
					</tr>
				</tbody>
			</table>
