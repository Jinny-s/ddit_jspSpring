			...
			<table class="table">
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="email" class="form-control align-middle" name="memEmail" placeholder="이메일을 입력하세요" required="required">
						</td>
					</tr>
					<tr>
						<th class="align-middle">전화번호</th>
						<td>
							<input type="text" class="form-control align-middle" name="memHp" placeholder="전화번호를 입력하세요" required="required">
						</td>
					</tr>
				</tbody>
			</table>
